...
| Windows | Downloads `https://sca-downloads.veracode.com/ci.ps1` and runs it with `-ArgumentList scan, --recursive, --update-advisor` ([docs](https://docs.veracode.com/r/t_sc_agent_proxy)) |
